...
export function Button({ 
  ...
  const variants = {
    primary: 'bg-green-700 text-white dark:bg-green-800 dark:hover:bg-green-700',
    ...
    accent: 'bg-orange-600 hover:bg-orange-700 text-white dark:bg-orange-500 dark:hover:bg-orange-600',
  };
